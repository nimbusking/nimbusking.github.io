...
### 支付架构全景剖析
【备注】
- 本小节部分内容参考：[《图解支付系统设计与实现》精华版一文](https://blog.csdn.net/yinmo_sc/article/details/143957256)
- 部分内容结合之前工作场景总结
- 本小节意在更细致的，从整体结构看支付全链路

#### 一张老图
![支付架构(旧)](3a538a14/支付架构(旧).jpeg)
TODO 待重新绘制
~~【备注】改图从网络上公开的支付系统架构图，原图片过老，水印过多，我这边重新整合，重新绘制。~~
