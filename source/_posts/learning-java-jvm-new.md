...
![对象内存分配示意图](post/d16864e6/对象内存分配示意图.png)
...
![老年代空间分配担保流程](post/d16864e6/老年代空间分配担保流程.png)
...
![标记清除算法示意图](post/d16864e6/mark-sweep.png)
##### 标记-复制（Mark-Copy）
...
![标记复制算法示意图](post/d16864e6/mark-copy.png)
...
![标记整理算法示意图](post/d16864e6/mark-compact.png)
##### 三个回收算法之间的羁绊（总结）
两个羁绊：
...
![卡表与卡页对应示意图](post/d16864e6/card-table_with_card-page.png)
...
![并发出现对象消失问题示意](post/d16864e6/并发出现对象消失问题示意.png)
